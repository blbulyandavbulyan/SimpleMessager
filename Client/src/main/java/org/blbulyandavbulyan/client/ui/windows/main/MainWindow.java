package org.blbulyandavbulyan.client.ui.windows.main;
...
import org.blbulyandavbulyan.client.serverconnection.MessagesReaderThread;
import org.blbulyandavbulyan.client.serverconnection.ServerConnection;
import org.blbulyandavbulyan.client.serverconnection.exceptions.ConnectionClosed;
import org.blbulyandavbulyan.client.serverconnection.interfaces.MessagePrinter;
import org.blbulyandavbulyan.client.serverconnection.interfaces.MessageSender;
import org.blbulyandavbulyan.client.ui.common.DisplayErrors;
import org.blbulyandavbulyan.client.ui.windows.exceptions.PersonalMessageIsEmpty;
...
import org.blbulyandavbulyan.client.ui.components.custom.jtabbedpanewithcloseabletabs.JTabbedPaneWithCloseableTabs;
import org.blbulyandavbulyan.client.ui.components.displayers.messagedisplaying.messagepanels.filemessagespanels.ImageFileMessagePanel;
import org.blbulyandavbulyan.client.ui.components.draganddroppanel.DragAndDropPanel;
import org.blbulyandavbulyan.client.ui.components.draganddroppanel.interfaces.DroppedFilesAdapter;
import org.blbulyandavbulyan.client.ui.components.custom.textfieldswithghosttext.JTextFiledWithGhostText;
import org.blbulyandavbulyan.client.ui.components.displayers.messagedisplaying.exceptions.UnknownMessageTypeException;
import org.blbulyandavbulyan.client.ui.components.displayers.messagedisplaying.messagepanels.MessagePanel;
import org.blbulyandavbulyan.client.ui.components.displayers.generators.MessagePanelGenerator;
...
public class MainWindow extends JFrame implements MessagePrinter {
    ...
    private void init() {
        ...
        ActionListener sendMessage = (e) -> {
            ...
            if (!(message.isBlank() && message.isEmpty())) {
                try {
                    ...
                    DisplayErrors.showErrorMessage(((JComponent) e.getSource()).getParent(), "mainWindow.errorMessages.emptyPersonalMessage",
                            "mainWindow.errorCaptions.messageSendingError", rb);
                    messageField.requestFocus();
                }
                catch (ConnectionClosed ex) {
                    DisplayErrors.showErrorMessage(((JComponent) e.getSource()).getParent(),
        ...
        try {
            ...
            RecordStopButtonActionListener recordStopActionListener = new RecordStopButtonActionListener(audioFormat, 3,
                ...
                (audioData)->{
                    try {
                        ...
                        DisplayErrors.showErrorMessage(this, "errorMessages.emptyAudioMessage", "errorCaptions.sendingError", rb);
            ...
            DisplayErrors.showErrorMessage(null, "mainWindow.errorMessage.VoiceMessageIsNotSupported", "errorCaptions.generalErrorCaption", rb);
        }
    ...
    synchronized public void printMessage(Message msg) {
        try {
            ...
            DisplayErrors.showErrorMessage(this, "mainWindow.errorMessages.UnknownMessageType", "mainWindow.errorCaptions.messageDisplayingError", rb);
        }
        catch (Exception e) {
            throw new RuntimeException(e);
        }
